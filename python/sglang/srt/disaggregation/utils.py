...
class MetadataBuffers:
    ...
    def set_buf(self, req: Req):
        ...
        self.cached_tokens[req.metadata_buffer_index][0] = getattr(
            req, "cached_tokens", 0
        )
        self.cached_tokens[req.metadata_buffer_index][1] = getattr(
            req, "cached_tokens_device", 0
        )
        self.cached_tokens[req.metadata_buffer_index][2] = getattr(
            req, "cached_tokens_host", 0
        )
        self.cached_tokens[req.metadata_buffer_index][3] = getattr(
